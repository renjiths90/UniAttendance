				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
                            ...
                            if($count == 0) {
                                $ins_query = "INSERT INTO `temp_attendance` (`subject_id`, `faculty_id`, `student_id`, `attedance_date`, `attendance`) VALUES ('".$subject_id."', '".$_SESSION['faculty_id']."', '".$att->student_id."', now(), '". $att->status . "')";
